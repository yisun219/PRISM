...
export default function About({ content, title = 'About' }: AboutProps) {
    return (
        ...
        >
            ...
            <div className="text-[0.96rem] text-neutral-700 dark:text-neutral-600 leading-[1.8] text-pretty">
                <ReactMarkdown
                    components={{
                        ...
                        a: ({ ...props }) => (
                            <a
                                ...
                                className="text-accent-dark dark:text-accent font-semibold underline decoration-accent/35 underline-offset-4 transition-colors hover:decoration-accent"
                            />
                        ),
                        blockquote: ({ children }) => (
